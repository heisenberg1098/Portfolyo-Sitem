...
const ContactForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      toast({
        title: "Teşekkürler!",
        description: "En kısa sürede sana dönüş yapacağım.",
        variant: "default",
      ...
      toast({
        ...
        description: "Lütfen alanları kontrol edip tekrar dene.",
        className: cn(
  ...
  return (
    <form className="min-w-7xl mx-auto sm:mt-4" onSubmit={handleSubmit}>
      ...
      <div className="grid w-full gap-1.5 mb-4">
        ...
        <Textarea
          placeholder="Projenizden veya fikrinizden bahsedebilirsiniz..."
          id="content"
          required
          value={message}
        ...
        <p className="text-sm text-muted-foreground">
          Bilgileriniz üçüncü kişilerle paylaşılmaz. Söz ✋
        </p>
      </div>
      ...
      >
        {loading ? (
          ...
          <div className="flex items-center justify-center">
            Mesajı Gönder <ChevronRight className="w-4 h-4 ml-4" />
          </div>
        )}
        <BottomGradient />
      </Button>
