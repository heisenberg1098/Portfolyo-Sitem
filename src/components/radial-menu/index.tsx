...
const MENU_ITEMS: MenuItem[] = [
  { id: 'love',  emoji: '❤️', label: 'Sevgi',   color: '#ef4444' },
  { id: 'laugh', emoji: '😂', label: 'Kahkaha', color: '#fbbf24' },
  { id: 'wow',   emoji: '😮', label: 'Vay',     color: '#3b82f6' },
  { id: 'sad',   emoji: '😢', label: 'Üzgün',   color: '#60a5fa' },
  { id: 'angry', emoji: '😡', label: 'Kızgın',  color: '#f97316' },
  { id: 'fire',  emoji: '🔥', label: 'Efsane',  color: '#f59e0b' },
];
